...
#Region "Codabar"
    'Info útil: http://en.wikipedia.org/wiki/Codabar
...
#Region "PDF417 (2d)"
    ...
    Public Shared Function PDF417(ByVal _code As String, _
                                  Optional ByVal Scale As Double = 1, _
                                  Optional ByVal _Error_Nivel As Integer = 8) As Bitmap
        If _code.Trim = "" Then
            Return Nothing
        Else
            ...
            'barcode.YHeight = 6
            barcode.ErrorLevel = _Error_Nivel
